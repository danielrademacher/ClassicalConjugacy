...
SOPlus := function(a, b) end;
SOMinus := function(a, b) end;
...
XOR := function(A, B) return (A and not B) or (not A and B); end;
InternalConjugacyInvariantSp := function(g) end;
InternalConjugacyInvariantGU := function(g) end;
InternalConjugacyInvariantO := function(g) end;